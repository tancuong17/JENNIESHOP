<div id="menu-container">
    ...
    <a href="http://localhost/shop/manage/logout" class="sub_menu_button" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 0.5rem 0.5rem 0 0">
